...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('performances', function (Blueprint $table) {
            $table->id();
            $table->date('date')->comment('تاریخ ثبت عملکرد');
            ...
            // اعتبارسنجی
            $table->unsignedBigInteger('validation_status_id')->default(1)->comment('وضعیت اعتبارسنجی');
            ...
            $table->string('validated_by', 20)->nullable()->comment('کد پرسنلی ادمین');
